...
public class Helper2D {
    ...
    private static final java.util.HashMap<String, ResourceLocation> locationCache = new java.util.HashMap<>();
    ...
    public static void drawPicture(int x, int y, int w, int h, int color, String location) {
        ...
        ResourceLocation resourceLocation = locationCache.get(location);
        if (resourceLocation == null) {
            resourceLocation = new ResourceLocation(Cloud.modID, location);
            locationCache.put(location, resourceLocation);
        }
