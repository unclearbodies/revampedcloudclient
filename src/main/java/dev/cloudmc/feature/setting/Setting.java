...
public class Setting {
    ...
    private transient float maxNumber;
    private transient float minNumber;
    ...
    public Setting(String name, Mod mod, float maxNumber, float currentNumber) {
        this(name, mod, 0.0f, maxNumber, currentNumber);
    }

    /**
     * A setting with a slider which can go from minNumber to maxNumber
     */

    public Setting(String name, Mod mod, float minNumber, float maxNumber, float currentNumber) {
        this.mode = "Slider";
        this.name = name;
        this.mod = mod;
