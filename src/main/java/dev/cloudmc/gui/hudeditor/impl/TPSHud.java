...
public class TPSHud extends HudMod {
    public TPSHud(String name, int x, int y) {
        super(name, x, y);
    }
    ...
    public void renderMod(int mouseX, int mouseY) {
        ...
        if (Cloud.INSTANCE.modManager.getMod("TPS").isToggled()) {
            String text = String.format("TPS: %.1f", TPSMod.getTPS());
