...
import dev.cloudmc.gui.hudeditor.impl.*;
import dev.cloudmc.gui.hudeditor.impl.keystrokes.KeystrokesHud;
...
public class HudEditor extends GuiScreen {
    ...
    public void init() {
        ...
        addHudMod(new ComboHud("Combo Counter", index, offset));
        addHudMod(new SessionStatsHud("Session Stats", index, offset));
        addHudMod(new SaturationHud("Saturation", index, offset));
        addHudMod(new HitDistanceHud("Hit Distance", index, offset));
        addHudMod(new TPSHud("TPS", index, offset));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (HudMod hudMod : hudModList) {
            ...
            if (hudMod.isDragging() && Style.isSnapping()) {
                for (HudMod sHudMod : hudModList) {
                    if (Cloud.INSTANCE.modManager.getMod(sHudMod.getName()).isToggled() && !sHudMod.equals(hudMod)) {
